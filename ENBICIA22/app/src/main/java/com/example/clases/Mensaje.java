...
public class Mensaje {
    ...
    public Ciclista getReceptor() { return receptor; }

    public void setReceptor(Ciclista receptor) { this.receptor = receptor; }

    public Ciclista getEmisor() { return emisor; }

    public void setEmisor(Ciclista emisor) { this.emisor = emisor; }
}
